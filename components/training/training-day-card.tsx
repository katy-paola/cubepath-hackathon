...
const COPY = {
  ...
  energy: "Media",
  energyOptions: ["Media", "Baja", "Alta"] as const,
  time: "45min",
  timeOptions: ["45min", "30min", "60min"] as const,
  location: "Exterior",
  locationOptions: ["Exterior", "Interior"] as const,
  discomfort: "Nada",
  discomfortOptions: ["Nada", "Molestias", "Mucho"] as const,
